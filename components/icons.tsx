  ...
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13M3 6.253A3.374 3.374 0 015.263 5H18.737A3.374 3.374 0 0121 6.253v13A3.374 3.374 0 0118.737 20H5.263A3.374 3.374 0 013 18.747V6.253z"
      />
    </svg>
  )
}
...
export function FastForward({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
